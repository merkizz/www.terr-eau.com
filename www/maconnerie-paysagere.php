...
<table width="950" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td valign="top" style="background:transparent url('gfx/page_03.jpg') no-repeat top left; height:48px;padding-left:482px"><h1 id="id_h1"><span>M</span>a&ccedil;onnerie paysag&egrave;re</h1></td>
  </tr>
  <tr>
    <td valign="top" bgcolor="#f7f7f7"><table width="100%" height="352" border="0" cellpadding="0" cellspacing="0" style="background-image:url(gfx/page_04.jpg); background-position:top left; background-repeat:no-repeat;">
      ...
      <tr>
        <td valign="top"><?php require_once 'gestion/inc/misc.php';HtdtcShow('content/l1/','034Maconnerie paysagere.txt');?></td>
      </tr>
	   <tr>
        <td>&nbsp;</td>
      </tr>
